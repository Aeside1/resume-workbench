 ...
 * 「简历亮点提炼」按钮（原「抽屉打开时点另一张卡片直接换绑」的交互已按决策退役）。
 */
    ...
    >
      <Drawer.Backdrop>
        <Drawer.Content placement="right">
          <Drawer.Dialog aria-label="简历亮点提炼抽屉" className="resume-drawer-panel">
            ...
            <Drawer.Body className="resume-drawer-body">
              {workContent && <ResumeHighlightsFeed workContent={workContent} session={session} />}
            </Drawer.Body>
          </Drawer.Dialog>
        </Drawer.Content>
      </Drawer.Backdrop>
